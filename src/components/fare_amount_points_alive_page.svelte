<script>
    ...
    function generatePoints() {
        ...
        for (let i = 0; i < totalGeneratedPoints; i++) {
            ...
            points.push({
                ...
                isBlue: i < 959, // <30
                isBlueDead: i > 298 && i < 959,
                isRed: i >= 958 + 62 + 30 && i < 958+62+266, // 30-100
                isRedDead: i > 958 + 62 + 266 - 142 && i < 958 + 62 + 266,
    ...
    $: isVisible = index === 10 && (fareVisualization === 'casualty');

    let pieData = [
        { value: 31.1, color: 'blue' },
        {value: 68.9, color: "blue", opacity: 0.5}
    ];
    ...
    let pieData_2 = [
        { value: 70.6, color: 'green' },
        {value: 29.4, color: "green", opacity: 0.5}
    ];
...
<style>
    ...
    .graph-container {
        position: absolute;
        top: 70px; /* Adjust this value to move the graph up or down */
